...
<main id="content" role="main" class="main">
      ...
      <div class="table-responsive datatable-custom">
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              <th style="width: 1%;">#</th>
              <th class="table-column-ps-0" style="width: 15%;">User Name</th>
              ...
              <tr>
                ...
                <td class="text-start text-nowrap">
                  <div class="btn-group" role="group">
                    <a class="btn btn-white btn-sm" href="<?= base_url('admin/' . $user->userid); ?>">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="ordersExportDropdown1">
                        <a href="<?= base_url('admin/editUser/' . $user->userid); ?>" class="dropdown-item" style="width: 100p;">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#deleteModal"
                          data-delete-url="<?= base_url('admin/deleteUser/' . $user->userid); ?>">
      ...
      <div class="card-footer">
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
          ...
          <div class="col-sm-auto">
            <a href="<?= base_url('admin/tambah_user'); ?>" class="btn btn-success me-4">
  ...
  <script>
    ...
    deleteModal.addEventListener('show.bs.modal', function(event) {
      ...
      // Ambil URL hapus dari tombol yang diklik
      const deleteUrl = button.getAttribute('data-delete-url');

      // Temukan tombol konfirmasi di dalam modal dan set URL hapus
