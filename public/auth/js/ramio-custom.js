...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2024, 5, 30), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
  ...
  //if(bgndKenburns.length){
    //bgndKenburns.vegas({
      ...
      //slides: [
        //{ src: "img/backgrounds/bg-main-color-1.webp" },
        //{ src: "img/backgrounds/bg-main-color-2.webp" },
        //{ src: "img/backgrounds/bg-main-color-3.webp" }
      //],
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/bg-main-monochrome_1.webp" },
        { src: "img/backgrounds/bg-main-monochrome_2.webp" },
        { src: "img/backgrounds/bg-main-monochrome_3.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  if(bgndKenburns1.length){
    bgndKenburns1.vegas({
      ...
      slides: [
        { src: "img/backgrounds/bg-main-color-1.webp" },
        { src: "img/backgrounds/bg-main-color-1_1.webp" },
        { src: "img/backgrounds/bg-main-color-1_2.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  if(bgndKenburns2.length){
    bgndKenburns2.vegas({
      ...
      slides: [
        { src: "img/backgrounds/bg-main-color-2.webp" },
        { src: "img/backgrounds/bg-main-color-2_1.webp" },
        { src: "img/backgrounds/bg-main-color-2_2.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  if(bgndKenburns3.length){
    bgndKenburns3.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/bg-main-color-3_1.webp" },
        { src: "img/backgrounds/bg-main-color-3_2.webp" },
        { src: "img/backgrounds/bg-main-color-3_3.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  if(bgndKenburns4.length){
    bgndKenburns4.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/bg-main-color-4_1.webp" },
        { src: "img/backgrounds/bg-main-color-4_2.webp" },
        { src: "img/backgrounds/bg-main-color-4_3.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
